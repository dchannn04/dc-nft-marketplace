...
describe("NFTMarketplace", function(){
	...
	describe("Deployment", function(){
		it("Should track the name and symbol of the nft collection", async function (){
			expect(await nft.name()).to.equal("DC NFT")
			expect(await nft.symbol()).to.equal("DC")
		})
	...
	describe ("Making marketplace items", function () {
		...
		it("Should track newly created item, transfer NFT from seller to marketplace and emit Offered event", async function (){
			...
			//get item from items maping then check fields to ensure they are correct
	...
	describe("Purchasing marketplace items", function () {
    	...
    	it("Should fail for invalid item ids, sold items and when not enough ether is paid", async function () {
      		...
      		// but not the additional market fee.
      		await expect(
